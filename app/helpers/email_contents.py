                                                            ...
                                                            <td align="left" valign="top" style="padding-top: 24px">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="{{reset_password_url}}"
                                                                        style="display: inline-block; background-color: #002D62; font-size: 14px; line-height: 21px; font-weight: 700; color: #ffffff; padding-top: 8px; padding-right: 16px; padding-bottom: 8px; padding-left: 16px; text-decoration: none; border-radius: 4px;">Reset Password
                                                                        </a>
                                                                </div>
                                                                <p style="
                                                                font-size: 16px;
                                                                ...
                                                                "><a href={{reset_password_url}} target="_blank"
                                                                        style=" color: #007FFF;">{{reset_password_url}}</a></p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
